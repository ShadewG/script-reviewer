...
interface ScriptTemplate {
  ...
  defaultFootage: string[];
  defaultHasMinors: boolean;
  scaffold: string;
}
...
const SCRIPT_TEMPLATES: ScriptTemplate[] = [
  {
    id: "cold_case",
    label: "Cold Case",
    description: "Unsolved homicide/disappearance revisited with new evidence or theories",
    defaultState: "California",
    defaultCaseStatus: "unsolved",
    defaultFootage: ["911 Calls", "News Clips", "Photos"],
    defaultHasMinors: false,
    scaffold: `[COLD CASE TEMPLATE]

TITLE: [Case Name] — [Year]

COLD OPEN:
[Opening hook — discovery of the crime, present-day scene revisit, or new development]

VICTIM PROFILE:
[Full name, age at time, occupation, family context, community standing]

THE CRIME:
[Date, location, circumstances of discovery]
[Initial investigation — responding officers, crime scene details]
[Cause of death / nature of crime]

INVESTIGATION TIMELINE:
[Key dates and developments]
[Evidence collected — physical, forensic, witness statements]
[Suspects identified and cleared]

PERSONS OF INTEREST:
[Name, relationship to victim, alibi, motive]
[Any polygraph results, witness accounts]

WHY IT WENT COLD:
[Lack of evidence, jurisdictional issues, technology limitations]
[Any departmental failures or controversies]

NEW DEVELOPMENTS:
[DNA advances, new witnesses, podcast/media attention, cold case unit review]

THEORIES:
[Theory 1 — supporting evidence, counterarguments]
[Theory 2 — supporting evidence, counterarguments]

CURRENT STATUS:
[Active/inactive, reward information, contact for tips]

CLOSING:
[Impact on family/community, call to action]`,
  },
  {
    id: "trial_recap",
    label: "Trial Recap",
    description: "Coverage of a completed or ongoing criminal trial",
    defaultState: "Florida",
    defaultCaseStatus: "convicted",
    defaultFootage: ["Court Footage", "Interrogation", "News Clips"],
    defaultHasMinors: false,
    scaffold: `[TRIAL RECAP TEMPLATE]

TITLE: The Trial of [Defendant Name] — [Year]

COLD OPEN:
[Dramatic moment from trial — key testimony, verdict reading, or courtroom reaction]

CASE BACKGROUND:
[Crime summary — what happened, when, where]
[Victim(s) — names, ages, relationship to defendant]
[Arrest and charges filed]

PRE-TRIAL:
[Bail hearing, plea entered]
[Key pre-trial motions — suppression of evidence, change of venue]
[Defense strategy signals, prosecution theory]

PROSECUTION'S CASE:
[Opening statement summary]
[Key witnesses and testimony]
[Physical evidence presented]
[Expert testimony — forensics, digital evidence, medical examiner]

DEFENSE'S CASE:
[Defense theory — alibi, alternative suspect, self-defense, mental health]
[Defense witnesses]
[Cross-examination highlights]

KEY MOMENTS:
[Pivotal testimony or evidence that shifted the trial]
[Objections, sidebar discussions, judge's rulings]
[Emotional moments — victim impact, defendant behavior]

VERDICT AND SENTENCING:
[Jury deliberation duration]
[Verdict on each count]
[Sentencing — terms, judge's remarks]

AFTERMATH:
[Appeals filed or planned]
[Public/media reaction]
[Impact on victims' families]

CLOSING:
[Legal significance, precedent set, lessons learned]`,
  },
  {
    id: "missing_person",
    label: "Missing Person",
    description: "Disappearance investigation — active or resolved",
    defaultState: "Texas",
    defaultCaseStatus: "unsolved",
    defaultFootage: ["Surveillance", "911 Calls", "News Clips", "Photos"],
    defaultHasMinors: false,
    scaffold: `[MISSING PERSON TEMPLATE]

TITLE: The Disappearance of [Name] — [Year]

COLD OPEN:
[Last known sighting, the moment someone realized they were gone]

THE MISSING PERSON:
[Full name, age, physical description]
[Occupation, daily routine, personality]
[Family situation, relationships]

LAST KNOWN MOVEMENTS:
[Timeline of final 24-48 hours]
[Last confirmed sighting — location, time, witnesses]
[Digital footprint — phone records, social media, bank activity]
[Vehicle/belongings — what was found, what's missing]

THE SEARCH:
[When reported missing and by whom]
[Initial search efforts — ground, aerial, K-9]
[Search area and conditions]

INVESTIGATION:
[Persons of interest — relationships, alibis, behavior]
[Evidence gathered — forensics, phone data, surveillance footage]
[Polygraphs administered and results]

THEORIES:
[Voluntary disappearance — evidence for/against]
[Foul play — suspects, motive, opportunity]
[Accident — terrain, weather, health conditions]

DEVELOPMENTS:
[Any remains or belongings found]
[Arrests or charges]
[Media attention, community efforts]

CURRENT STATUS:
[Active/inactive investigation]
[Reward amount, tip line]

CLOSING:
[Family's ongoing search, community impact]`,
  },
  {
    id: "serial_killer",
    label: "Serial Killer Profile",
    description: "Deep dive into a serial offender's crimes, psychology, and capture",
    defaultState: "Washington",
    defaultCaseStatus: "convicted",
    defaultFootage: ["Interrogation", "Court Footage", "News Clips", "Photos"],
    defaultHasMinors: false,
    scaffold: `[SERIAL KILLER PROFILE TEMPLATE]

TITLE: [Name/Alias] — [Active Years]

CONTENT WARNING:
[This video contains descriptions of violence and murder]

COLD OPEN:
[Discovery of pattern, arrest moment, or survivor account]

EARLY LIFE:
[Childhood, family background, early behavioral signs]
[Education, relationships, employment history]
[Prior criminal record, escalation pattern]

THE CRIMES:
[Victim 1 — name, date, location, circumstances]
[Victim 2 — name, date, location, circumstances]
[Pattern analysis — victim type, method, geography, cooling-off period]
[NOTE: Treat each victim as a person, not just a statistic]

INVESTIGATION:
[How pattern was identified]
[Task force formation, jurisdictional coordination]
[Key evidence breaks — DNA, witnesses, behavioral analysis]
[Near-misses — times they almost got caught]

THE CAPTURE:
[How they were caught]
[Arrest details]
[Initial interrogation and confession (if any)]
...
PSYCHOLOGY:
[Expert analysis — profiling, diagnosis]
[Interviews from prison (if available)]
[Motivations as understood by investigators]

AFTERMATH:
[Additional victims identified/suspected]
[Impact on law enforcement practices]
[Survivors' stories]

CLOSING:
[Legacy of the case, victims remembered]`,
  },
  {
    id: "wrongful_conviction",
    label: "Wrongful Conviction",
    description: "Exoneration case — false conviction and path to freedom",
    defaultState: "New York",
    defaultCaseStatus: "acquitted",
    defaultFootage: ["Court Footage", "Interrogation", "News Clips"],
    defaultHasMinors: false,
    scaffold: `[WRONGFUL CONVICTION TEMPLATE]

TITLE: [Name]'s Fight for Freedom — [Years Served] Years

COLD OPEN:
[Release moment, or the evidence that changed everything]

THE ORIGINAL CRIME:
[What happened — date, location, victim(s)]
[Initial investigation and evidence collected]

THE WRONGFUL CONVICTION:
[How [Name] became a suspect]
[Problems with the investigation — tunnel vision, witness pressure, forensic errors]
[Trial — prosecution's case, defense shortcomings]
[Conviction and sentencing]

LIFE IN PRISON:
[Years served]
[Maintaining innocence, appeals filed]
[Impact on family]

THE PATH TO EXONERATION:
[Who took up the case — Innocence Project, new attorney, journalist]
[New evidence — DNA, recanted testimony, alternative suspect]
[Legal proceedings — hearings, new trial, dismissal]

WHAT WENT WRONG:
[Eyewitness misidentification]
[False confession / coerced statements]
[Forensic science errors — bite marks, hair analysis, etc.]
...
[Reforms prompted by the case]
[Real perpetrator — identified? convicted?]

CLOSING:
[Systemic lessons, policy changes, ongoing advocacy]`,
  },
];
...
export default function Home() {
  ...
  const applyTemplate = (templateId: string) => {
    ...
    if (!tmpl) return;
    setScript(tmpl.scaffold);
    setState(tmpl.defaultState);
    setCaseStatus(tmpl.defaultCaseStatus);
    setFootageTypes(tmpl.defaultFootage);
    setHasMinors(tmpl.defaultHasMinors);
    setInputMode("paste");
  };
    ...
    <div className="min-h-screen p-4 max-w-5xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="md:col-span-2" data-tour="script-input">
          {/* Script Templates */}
          {!running && !script && inputMode === "paste" && (
            <div className="mb-4 border border-[var(--border)] bg-[var(--bg-surface)] p-3">
              <p className="text-[10px] text-[var(--text-dim)] uppercase tracking-wider mb-2">Start from a template</p>
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-2">
                {SCRIPT_TEMPLATES.map((tmpl) => (
                  <button
                    key={tmpl.id}
                    onClick={() => applyTemplate(tmpl.id)}
                    className="text-left border border-[var(--border)] p-2 hover:border-[var(--text-dim)] hover:bg-[var(--bg-elevated)] transition-colors"
                  >
                    <span className="text-xs text-[var(--text-bright)] uppercase tracking-wider block">{tmpl.label}</span>
                    <span className="text-[10px] text-[var(--text-dim)] leading-tight block mt-0.5">{tmpl.description}</span>
                  </button>
                ))}
              </div>
            </div>
